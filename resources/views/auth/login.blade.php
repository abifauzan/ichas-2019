...
<head>
    ...
    <title>ICHAS 2019 | Login to Dashboard</title>
...
<body>
	...
	<nav>
		<ul class="cd-primary-nav">
			...
			<li><a href="#" class="animated_link">Login</a></li>
		...
		<div class="row row-height">
			<div class="col-lg-6 content-left">
				<div class="content-left-wrapper">
					...
					<!-- /social -->
					<div>
						<figure><img src="{{ asset('auth_assets/img/info_graphic_5.svg')}}" alt="" class="img-fluid"></figure>
						<h2>Login to Dashboard</h2>
                        <p>Please login to Dashboard Area with your registered account for : <br>upload your receipt of payment, upload your abstract submission, upload your paper and get E-Certificate</p>
			...
			<div class="col-lg-6 content-right" id="start">
				...
				<div id="wizard_container">
					<div id="top-wizard">
						...
						<!-- /top-wizard -->
                        <form id="wrapped" method="POST" action="{{ route('login') }}">
                            @csrf
							{{-- <input id="website" name="website" type="text" value=""> --}}
							<!-- Leave for security protection, read docs for details -->
							<div id="middle-wizard">
								<div class="step">
									<h3 class="main_question">Please input your E-Mail and Password</h3>
									<div class="form-group">
                                        <input type="email" name="email" class="form-control {{ $errors->has('email') ? ' required' : '' }}" name="email" value="{{ old('email') }}" placeholder="E-Mail" value="{{ old('email') }}" required autofocus>
									</div>
									<div class="form-group">
                                        <input type="password" name="password" class="form-control {{ $errors->has('password') ? ' required' : '' }}" placeholder="Password" required>
                                    </div>
							...
							<div id="bottom-wizard">
                                <button type="submit" name="foward" class="forward">Login</button>
							</div>
							<!-- /bottom-wizard -->
                        </form>

                        <a href="{{route('password.request')}}" style="float:right; margin-top: 20px;">Forgot Password ?</a>
					</div>
					<!-- /Wizard container -->
			</div>
			<!-- /content-right-->
