					...
					<div id="top-wizard">
                        ...
                        <form id="wrapped" method="POST" action="{{ route('password.email') }}">
							...
							<div id="middle-wizard">
								<div class="step">
									<h3 class="main_question">Please input your E-Mail</h3>
									<div class="form-group">
                                        <input type="email" name="email" class="form-control {{ $errors->has('email') ? ' required' : '' }}" name="email" value="{{ old('email') }}" placeholder="E-Mail" required autofocus>
									</div>
								</div>
							</div>
							<!-- /middle-wizard -->
							<div id="bottom-wizard">
                                <button type="submit" name="foward" class="forward">{{ __('Reset Password') }}</button>
							</div>
							<!-- /bottom-wizard -->
                        </form>
