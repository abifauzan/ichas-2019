...
@section('content')
     ...
     <section class="banner">
         <div class="container">
             <h2 class="wow fadeInUp">International Conference 2019</h2>
        ...
        <div class="container">
           <div class="tittle">
                ...
                <ul class="nav tab_list">
                    <li><a class="nav-link" data-toggle="pill" href="#monthly" role="tab">Day 1</a></li>
                    <li><a class="nav-link active" data-toggle="pill" href="#annual" role="tab">Day 2</a></li>
                </ul>
           </div>
