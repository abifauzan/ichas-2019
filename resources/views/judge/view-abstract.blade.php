        ...
        @if(count($datas) > 0)
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Incoming Abstract</h6>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span data-toggle="modal" data-target="#detail{{$no}}">
                                                <button class="btn btn-success btn-icon-anim btn-circle" data-toggle="tooltip" data-placement="top" title="Read Abstract"><i class="fa fa-book"></i></button>
                                            </span>&nbsp;&nbsp;

                                            <form action="{{route('approve.title')}}" method="POST" class="inline-block">
                                                @csrf
                                                <input type="hidden" name="id" value="{{$data->id}}">
                                                <button type="submit" class="btn btn-primary btn-icon-anim btn-circle" data-toggle="tooltip" data-placement="top" title="Approve Title" onclick="return confirm('Are you sure?');"><i class="icon-like"></i></button>&nbsp;&nbsp;&nbsp;
                                            </form>
                                        </td>
                                    </tr>
                                    <!-- Detail Modal -->
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h5 class="modal-title" id="myLargeModalLabel">Read Abstract</h5>
                                                </div>
