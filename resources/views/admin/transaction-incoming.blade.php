    ...
    @if(!(empty($userTransactions)))
        <div class="panel panel-default border-panel card-view panel-refresh">
            ...
            <div class="panel-heading">
                <div class="pull-left">
                    <h6 class="panel-title txt-dark">Incoming Transaction</h6>
                </div>
                            ...
                            <table class="table table-hover table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('registrant.payment.update')}}" method="POST">
                                                @csrf
                                                <input type="hidden" name="id" value="{{$item->id}}">
                                                <input type="hidden" name="id_user" value="{{$item->id_user}}">
                                                <button type="submit" onclick="return confirm('Approve data ?');" class="btn btn-sm btn-success btn-icon-anim btn-circle"><i class="icon-like"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
