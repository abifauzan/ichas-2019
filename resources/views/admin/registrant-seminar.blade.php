        ...
        @if(!(empty($userSeminars)))
            <div class="panel panel-default border-panel card-view panel-refresh">
                ...
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Total Participant of Seminar : {{count($userSeminars)}}</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body row pa-0">
                        ...
                        <div class="ml-30">{{ $userSeminars->links() }}</div>
                    </div>
                </div>
            </div>
        @else
